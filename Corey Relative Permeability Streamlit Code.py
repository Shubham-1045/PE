...
def export_to_ecl(system, saturation, kro, krw_or_krg, pc):
    ...
    if system == 'Water-Oil System':
        lines.append("-- Water-Oil Relative Permeability and Capillary Pressure Data")
        lines.append("SWOF")
        ...
        lines.append("-- Gas-Oil Relative Permeability and Capillary Pressure Data")
        lines.append("SGOF")
        ...
        lines.append("-- Gas-Water Relative Permeability and Capillary Pressure Data")
        lines.append("SGWFN")
